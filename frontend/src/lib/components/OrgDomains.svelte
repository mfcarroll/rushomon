<script lang="ts">
    ...
    async function handleAdd() {
        ...
        try {
            ...
            await orgsApi.addOrgDomain(orgId, domainStr);
            newDomain = '';
...
<div class="bg-white rounded-xl border border-gray-200 overflow-hidden shadow-sm mb-6">
    <div class="p-6 border-b border-gray-200">
        ...
        <p class="text-xs text-gray-500 mt-0.5">
            The part of your organizational email address after the @ sign.
        </p>
    </div>
                                    ...
                                    <div class="flex items-start gap-3 w-full mt-1">
                                        ...
                                        <div class="flex flex-1 shadow-sm">
                                            <input 
                                                type="text" 
                                                readonly 
                                                value={`"rushomon-verify=${d.verification_token}"`} 
                                            ...
                                            <button 
                                                type="button"
                                                onclick={() => copyToClipboard(`"rushomon-verify=${d.verification_token}"`, d.domain)} 
