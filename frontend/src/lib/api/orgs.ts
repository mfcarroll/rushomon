...
export const orgsApi = {
    ...
    async addOrgDomain(org_id: string, domain: string): Promise<{ domain: OrgDomain; instructions: string; token: string; verification_record: string }> {
        return apiClient.post<{ domain: OrgDomain; instructions: string; token: string; verification_record: string }>(`/api/orgs/${org_id}/domains`, { domain });
    },
